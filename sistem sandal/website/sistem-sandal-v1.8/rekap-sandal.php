                ...
                <section>
                    <div class="container" data-aos="fade-up">
                        <div class="section-header-data">
                            <h2>Rekap Sandal</h2>
                            <p> Berikut adalah rekap sandal pengunjung Masjid Agung Nur Sulaiman Banyumas</p>
                        </div>
                    </div>
                </section>
                <div class="table-responsive">
                    <table class="table dataTable my-0" id="dataTable">
                        ...
                        <tbody>
                            <?php
                            include "koneksi.php";
                            //baca tabel rekap sandal dan relasikan dengan tabel pengunjung berdasarkan nomor kartu RFID untuk tanggal hari ini

                            //baca tanggal saat ini
                            date_default_timezone_set('Asia/Jakarta');
                            $tanggal = date('Y-m-d');

                            //filter rekap penunjung berdasarkan tanggal saat ini
                            $sql = mysqli_query($konek, "select b.nama, a.tanggal, a.jam_masuk, a.jam_diambil from rekap_sandal a, pengunjung b where a.nokartu=b.nokartu and a.tanggal='$tanggal'");
                            $no = 0;
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td> <?php echo $data['jam_diambil']; ?> </td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
